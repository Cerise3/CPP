	...
	if (deg >= 5)
      {
		 ...
		 for (i = deg; i >= half; i--)
	       {
	         cout << setw (5) << coef [i] << " x^" << i << " + "; //same line as F(x) =
	       }

         Vertspc (3, 'c');
		 cout << setiosflags (ios :: fixed) << setw (20) << " ";
         for (i = (half - 1); i >= 1; i--)
           {
...
void Correct (double coef [], int deg, int j)
  ...
  // =========================================================================
    ...
    fout << setw (20) << "F (x) = ";
		 for (i = deg; i >= half; i--)
	       {
	         fout << setw (5) << coef [i] << " x^" << i << " + "; //same line as F(x) =
	       }
         Vertspc (3, 'f');
...
void Table (int k, double fa, double fb, double fx, double a, double b, double x)
  
  {
	...
	cout << setiosflags (ios :: fixed) << setprecision (3);
	cout << setw (10) << k << setw (10) << a << x << b << fa << fx << fb;
	DividerC ();
...
void Find (double coef [], int deg, int k)
{
  ...
  for (i = 0; i < deg; i++)
	...
	if ((count == deg) || (count == (deg - 1) && coef [0] != 0))
	  {
		if (count == deg)
	      {
		    Vertspc (3, 'c');
	        cout << setw (68) << "is a constant function with";
			cout <<	" trivial solution, the x-axis.";
	      ...
	      {
		    Vertspc (3, 'c');
		    cout << setw (60) << "is a constant function with no solution.";

			Vertspc (3, 'f');
		    fout << setw (60) << "is a constant function with no solution.";
	      }
	}
	else
	{
    ...
    if (fx == 0)
      {
		  Vertspc (3, 'c');
        cout << setw (56) << "You found the first positive root";
	Vertspc (1 , 'c');
	cout << setw (44) << "x = " << x;
	...
	fout << setw (44) << "x = " << x;
      ...
      {
		  Vertspc (3, 'c');
        cout << setw (66) << "You found an apporximation of the first positive root";
	Vertspc (2 , 'c');
	cout << setw (44) << "x = " << x;
